    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <fieldset class="layui-elem-field">
                <legend>评论管理 - 修改评论</legend>
                <div class="layui-field-box">

                    <form id="addCommentForm" class="layui-form"
                          action="${pageContext.request.contextPath}/api/comment/editComment.html" method="post">
                        <%--隐藏域，存储Id--%>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea name="commentArticle" required lay-verify="required" placeholder="请输入"
                                          class="layui-textarea">${comment.commentArticle}</textarea>
                            </div>
                        </div>
