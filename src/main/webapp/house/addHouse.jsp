    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <fieldset class="layui-elem-field">
                <legend>房屋管理 - 新增房屋</legend>
                <div class="layui-field-box">

                    <form id="addHouseForm" class="layui-form" action="${pageContext.request.contextPath}/house/addHouse.html" method="post">
                        <%--隐藏域，存储照片信息--%>
                        <input type="hidden" name="houseImg" id="photo">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea name="houseContent" placeholder="请输入内容" class="layui-textarea"></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">备注</label>
                            <div class="layui-input-block">
                                <textarea name="houseComment" placeholder="请输入内容" class="layui-textarea"></textarea>
                            </div>
                        </div>
