    ...
    <div class="layui-body">
        <div style="padding: 15px;">
            <fieldset class="layui-elem-field">
                <legend>报修管理 - 新增报修</legend>
                <div class="layui-field-box">

                    <form id="addRepairForm" class="layui-form" action="${pageContext.request.contextPath}/repair/addRepair.html" method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea name="repairContent" placeholder="请输入内容" class="layui-textarea"></textarea>
                            </div>
                        </div>
